            ...
            <div className=" overflow-hidden rounded-lg bg-white">
              ...
              <div className="p-8 text-start sm:p-9 md:p-7 xl:p-9">
                ...
                <label
                  ...
                  className="btn text-white  w-full text-center border-0 hover:bg-transparent rounded-2xl hover:border hover:border-red-500 bg-green-500 py-2  text-base font-medium transition hover:text-green-500"
                >
                  Booking Modal
                </label>
              </div>
