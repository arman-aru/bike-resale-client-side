...
const Header = () => {
  ...
  return (
    <Navbar className="mx-auto py-6 md:py-4 px-4 lg:px-8 lg:py-4 bg-green-500  text-white">
          ...
          <div className="mt-1">
            {user?.uid ? (
              ...
              <Link to="/login">
                <button
                  type="button"
                  className=" hidden md:block text-green-500 font-bold  bg-white  rounded-lg text-base px-8 py-2 text-center mr-2 mb-2"
                >
                  Sign In
                </button>
              </Link>
